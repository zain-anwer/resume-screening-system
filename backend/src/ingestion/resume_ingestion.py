...
from src.ingestion.utils.parser import get_all_candidates, extract_text, extract_cnic_details
...
def ingest_resumes(input_path: str, output_path: str):
    ...
    for candidate in candidates:
        ...
        cleaned_cnic_name = clean_text(cnic_data.get("name", None))
        cleaned_cnic_dob = clean_text(cnic_data.get("dob", None))
        cleaned_cnic_number = clean_text(cnic_data.get("cnic", None))
